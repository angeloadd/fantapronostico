        ...
        <div class="w-full space-y-1">
            ...
            @foreach($ranking as $position => $rank)
                <div @class([
                    ...
                    {{-- Rank badge --}}
                    <span @class([
                        'inline-flex items-center justify-center size-8 rounded-full font-bold text-sm shrink-0',
                        ...
                        'bg-gradient-to-br from-amber-700 to-amber-900 text-amber-100' => $position === 2,
                        'bg-gradient-to-br from-primary to-gray-500 text-primary-content' => $position >= 3 && $position <= 5,
                        'bg-gradient-to-br from-accent/30 to-accent/60 text-secondary-content' => $position === 6 || $position === 7,
                        'border border-accent/30' => $position > 7,
                    ])>{{ $position + 1 }}</span>
